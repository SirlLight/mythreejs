import './three.js'
import './DeviceOrientationControls.js'
import './FirstPersonControls.js'
import './OrbitControls.js'
import './helvetiker_regular.typeface.js'
	...
	function(module, exports) {
		...
		module.exports = {
			...
			init: function init() {
				...
				/*sun skin pic*/
				var sunSkinPic = THREE.ImageUtils.loadTexture('../assets/img/1/sun.jpg', {}, function () {
				...
				Sun = new THREE.Mesh(
					...
					new THREE.MeshLambertMaterial({
						emissive: 0xdd4422,
						map: THREE.ImageUtils.loadTexture('../assets/img/1/sun.jpg')
				}));
				Sun.name = 'Sun';
				Sun.castShadow = true;
				...
				Moon=new THREE.Mesh(
					...
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/moon.jpg')
						})
					);
				Moon.name="Moon";
				...
				var mlist = [
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/mercury.jpg')
						}), //0
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/venus.jpg')
						}), //1
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/earth.jpg')
						}), //2
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/mars.jpg')
						}), //3
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/wood.png')
						}), //4
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/saturn.png')
						}), //5
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/uranus.jpg')
						}), //6
					new THREE.MeshPhongMaterial({
						map: THREE.ImageUtils.loadTexture('../assets/img/1/neptune.jpg')
						})//7
				];
				for (var i = 0; i < 8; i++) {
					switch (i) {
